    ...
    <AppShell>
      <div className="mx-auto max-w-5xl space-y-6">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-semibold text-mist-50">Ask about your inbox</h1>
          <p className="mt-3 max-w-2xl text-base leading-7 text-mist-300">
            Ask about your latest briefing, or include a time range to check real Gmail and Calendar context.
          </p>
        </div>
